...
//Make sure the InputController.asset is moved to the ProjectSettings Folder
...
//		}
        ...
        public static Vector2 GetAxis(Axis axis, Index controlIndex, bool raw = false)
        {
            ...
            {
                Debug.LogError(e);
                Debug.LogWarning("Have you set up all axes correctly? \nThe easiest solution is to replace the InputController.asset with version located in the GamepadInput package. \nWarning: do so will overwrite any existing input");
            }
            return axisXY;
        }
